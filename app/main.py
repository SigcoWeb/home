...
@app.get("/walter2", response_class=HTMLResponse)
async def walter(request: Request):
    return templates.TemplateResponse("design_preview.html", {"request": request})


@app.get("/walter3", response_class=HTMLResponse)
async def walter(request: Request):
